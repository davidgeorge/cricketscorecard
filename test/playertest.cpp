...
XpUnitTest(BatsmanStrikeRateTest, "Testing the Batsman's strike rate")
{
   ...
   ss << steveWaugh.StrikeRate();
   std::string sExpected = "100.00";
   XpAssertEqual("Expecting a strike rate of 100", sExpected, ss.str());
   ...
   ss << std::fixed;
   ss << std::setprecision(2);
   ss << glennMcGrath.StrikeRate();
   XpAssertEqual("Expecting a strike rate of 10", sExpected, ss.str());
   ...
   ss << std::fixed;
   ss << std::setprecision(2);
   ss << adamGilchrist.StrikeRate();
   sExpected = "266.67";
   XpAssertEqual("Expecting a strike rate of 266.66", sExpected, ss.str());
}
